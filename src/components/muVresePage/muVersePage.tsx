    ...
    <div className="relative w-full flex justify-center">
      <div className="w-[90%]">
        <div className="z-20 md:mx-20 my-20">
          <h2 className="text-white gap-2 text-3xl font-[Montesrrat] text-left font-bold mb-10">
            The <span className="text-[#8c3bc3]">μ</span>Verse
          </h2>
          <p className="text-white md:text-xl  text-left mb-10 leading-snug text-pretty">
