...
const DEFAULT_DATA: LevelData[] = [
  {
    ...
    description: `Once, the Earth was a single piece of  connected land. We want the world of 
...
collaborate, and grow without limits, without boundaries. `,
  },
  {
    ...
    description: `Gatekeeping is a big no. We don’t hold opportunities for ourselves, we share 
them. 
...
success are open, fair, and accessible to all. `,
  },
  {
    ...
    description: `We should start treating the syllabus like a starting point and not a cage. 
...
const Pyramid: React.FC = () => {
  ...
  return (
    <div className="bg-bg-dark text-gray-100 font-sans selection:bg-pyramid-p2  selection:text-white">
      {/* Main Content */}
