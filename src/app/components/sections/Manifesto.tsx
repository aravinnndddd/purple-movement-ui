        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-gray-300 font-poppins font-light leading-relaxed border-l-2 border-purple-900/50 pl-5">
              We are the Manifestors of Change. Not waiting for the future, but building it with <span className="text-white font-medium">courage, code, creativity, and clarity</span>. We are the voice of a generation that refuses to settle.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-gray-300 font-poppins font-light leading-relaxed border-l-2 border-purple-900/50 pl-5">
              We are not consumers of culture; <span className="text-white font-medium">we are producers of purpose.</span> We break barriers for every young mind daring to dream. We believe in ecosystems that empower, not limit.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-900/10 to-transparent p-6 md:p-10 border border-purple-500/10">
            ...
            <p className="text-2xl md:text-4xl font-bold font-montserrat text-white leading-tight mb-3">
              This is <span className="bg-gradient-to-r from-[#7F39FD] to-[#DA9EFD] bg-clip-text text-transparent">The Purple Movement.</span>
            </p>
